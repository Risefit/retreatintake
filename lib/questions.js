...
export const STEPS = [
...

  {
    ...
    questions: [
      { id: 'reasons', type: 'long', required: true,
        label: 'What are your reasons for coming to the retreat?',
        help: 'People come for many reasons — for example: emotional healing, spiritual growth, working with addiction, finding life purpose, addressing physical or psychological pain, or moving through trauma. Please write in your own words. A paragraph or two is ideal.' },
      { id: 'intentions', type: 'long', required: true,
        label: 'What are your intentions and expectations for working with the medicine?',
        help: 'What are you hoping to meet, or move through, during your time with us? A paragraph or two is ideal.' },
